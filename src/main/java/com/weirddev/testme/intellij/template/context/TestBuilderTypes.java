...
public class TestBuilderTypes {
    ...
    private static final Map<String,String> JAVA9_REPLACEMENT_TYPES = new HashMap<>();
    private static final Map<String,String> JAVA9_REPLACEMENT_TYPES_FOR_RETURN = new HashMap<>();
    ...
    static {
        ...
        JAVA_9_COLLECTION_TYPES.put("java.util.Collection", "java.util.List.of(<VAL>)");
        JAVA_9_COLLECTION_TYPES.put("java.util.Deque", "new java.util.LinkedList<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.List", "java.util.List.of(<VAL>)");
        JAVA_9_COLLECTION_TYPES.put("java.util.Map", "java.util.Map.of(<VAL>,<VAL>)");
        JAVA_9_COLLECTION_TYPES.put("java.util.NavigableMap", "new java.util.TreeMap<>(java.util.Map.of(<VAL>,<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.NavigableSet", "new java.util.TreeSet<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.Queue", "new java.util.LinkedList<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.RandomAccess", "new java.util.Vector<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.Set", "java.util.Set.of(<VAL>)");
        JAVA_9_COLLECTION_TYPES.put("java.util.SortedSet", "new java.util.TreeSet<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.LinkedList", "new java.util.LinkedList<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.ArrayList", "new java.util.ArrayList<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.HashMap", "new java.util.HashMap<>(java.util.Map.of(<VAL>,<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.TreeMap", "new java.util.TreeMap<>(java.util.Map.of(<VAL>,<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.Vector", "new java.util.Vector<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.HashSet", "new java.util.HashSet<>(java.util.List.of(<VAL>))");
        JAVA_9_COLLECTION_TYPES.put("java.util.Stack", "new java.util.Stack<>(){{push(<VAL>);}}");
        JAVA_9_COLLECTION_TYPES.put("java.util.TreeSet", "new java.util.TreeSet<>(java.util.List.of(<VAL>))");
        ...
        JAVA9_REPLACEMENT_TYPES.putAll(JAVA_9_COLLECTION_TYPES);
        JAVA9_REPLACEMENT_TYPES_FOR_RETURN.putAll(JAVA_9_COLLECTION_TYPES);

        for (String javaFutureType : JAVA_FUTURE_TYPES) {
            //todo consider handling futures separately and avoid duplicating all replacement types
            LEGACY_JAVA_REPLACEMENT_TYPES.put(javaFutureType, "java.util.concurrent.CompletableFuture.completedFuture(<VAL>)");
            JAVA9_REPLACEMENT_TYPES.put(javaFutureType, "java.util.concurrent.CompletableFuture.completedFuture(<VAL>)");
            LEGACY_JAVA_REPLACEMENT_TYPES_FOR_RETURN.put(javaFutureType, "<VAL>");
            JAVA9_REPLACEMENT_TYPES_FOR_RETURN.put(javaFutureType, "<VAL>");
        }
    ...
    public static Map<String, String> getJava9ReplacementTypes(){
        return JAVA9_REPLACEMENT_TYPES;
    }
    public static Map<String, String> getJava9ReplacementTypesForReturn(){
        return JAVA9_REPLACEMENT_TYPES_FOR_RETURN;
    }

...
class TestTemplateContextBuilderTest {
        ...
        def methodReferencesBuilder = Mockito.mock(MethodReferencesBuilder)
    @Test
    void testPopulateDateFieldsSingleDigits() {
        new TestTemplateContextBuilder(builderFactory, methodReferencesBuilder).populateDateFields(fields, new GregorianCalendar(2020, 11, 5, 7, 5,3))
    ...
    void testPopulateDateFieldsDoubleDigits() {
        new TestTemplateContextBuilder(builderFactory, methodReferencesBuilder).populateDateFields(fields, new GregorianCalendar(2020, 0,25, 22, 45,33))

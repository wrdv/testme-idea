...
class FooTest {
    ...
    @Test
    void testCallOthers() {
        ChildWithSetters result = foo.callOthers(new ChildWithSetters(strField: "strField", someNumber: 0, fire: new FireBall(new JavaBean(myString: "myString", myDate: new GregorianCalendar(2016, Calendar.JANUARY, 11, 22, 45).getTime(), ice: new Ice(), someBinaryOption: true))))
        assert result == new ChildWithSetters(strField: "strField", someNumber: 0, fire: new FireBall(new JavaBean(myString: "myString", myDate: new GregorianCalendar(2016, Calendar.JANUARY, 11, 22, 45).getTime(), ice: new Ice(), someBinaryOption: true)))
    }
}

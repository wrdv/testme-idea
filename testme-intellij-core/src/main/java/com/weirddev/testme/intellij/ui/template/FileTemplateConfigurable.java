...
public class FileTemplateConfigurable implements Configurable, Configurable.NoScroll {
  private static final Logger LOG = Logger.getInstance("#FileTemplateConfigurable");
...
//      }
  ...
  private PsiFile createFile(final String text, final String name) {
    ...
    file.getViewProvider().putUserData(FileTemplateManager.DEFAULT_TEMPLATE_PROPERTIES, TestMeTemplateManager.getInstance(myProject).getDefaultProperties());
    return file;
  }
